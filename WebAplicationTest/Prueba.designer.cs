...
namespace WebAplicationTest
{
    ...
    partial void OnBHABILITADOChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Alumno_Matricula", Storage="_Matriculas", ThisKey="IIDALUMNO", OtherKey="IIDALUMNO")]
    ...
    partial void OnBHABILITADOChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sexo_Alumno", Storage="_Alumnos", ThisKey="IIDSEXO", OtherKey="IIDSEXO")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sexo_Docente", Storage="_Docentes", ThisKey="IIDSEXO", OtherKey="IIDSEXO")]
	...
	public partial class Aula : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<GradoSeccionAula> _GradoSeccionAulas;
    ...
    partial void OnBHABILITADOChanged();
		...
		public Aula()
		{
			this._GradoSeccionAulas = new EntitySet<GradoSeccionAula>(new Action<GradoSeccionAula>(this.attach_GradoSeccionAulas), new Action<GradoSeccionAula>(this.detach_GradoSeccionAulas));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Aula_GradoSeccionAula", Storage="_GradoSeccionAulas", ThisKey="IIDAULA", OtherKey="IIDAULA")]
		public EntitySet<GradoSeccionAula> GradoSeccionAulas
		{
			get
			{
				return this._GradoSeccionAulas;
			}
			set
			{
				this._GradoSeccionAulas.Assign(value);
			}
		}
		...
		private void attach_GradoSeccionAulas(GradoSeccionAula entity)
		{
			this.SendPropertyChanging();
			entity.Aula = this;
		}
		
		private void detach_GradoSeccionAulas(GradoSeccionAula entity)
		{
			this.SendPropertyChanging();
			entity.Aula = null;
		}
	...
	public partial class Curso : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<DetalleMatricula> _DetalleMatriculas;
		
		private EntitySet<PeriodoGradoCurso> _PeriodoGradoCursos;
    ...
    partial void OnBHABILITADOChanged();
		...
		public Curso()
		{
			this._DetalleMatriculas = new EntitySet<DetalleMatricula>(new Action<DetalleMatricula>(this.attach_DetalleMatriculas), new Action<DetalleMatricula>(this.detach_DetalleMatriculas));
			this._PeriodoGradoCursos = new EntitySet<PeriodoGradoCurso>(new Action<PeriodoGradoCurso>(this.attach_PeriodoGradoCursos), new Action<PeriodoGradoCurso>(this.detach_PeriodoGradoCursos));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Curso_DetalleMatricula", Storage="_DetalleMatriculas", ThisKey="IIDCURSO", OtherKey="IIDCURSO")]
		public EntitySet<DetalleMatricula> DetalleMatriculas
		{
			get
			{
				return this._DetalleMatriculas;
			}
			set
			{
				this._DetalleMatriculas.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Curso_PeriodoGradoCurso", Storage="_PeriodoGradoCursos", ThisKey="IIDCURSO", OtherKey="IIDCURSO")]
		public EntitySet<PeriodoGradoCurso> PeriodoGradoCursos
		{
			get
			{
				return this._PeriodoGradoCursos;
			}
			set
			{
				this._PeriodoGradoCursos.Assign(value);
			}
		}
		...
		private void attach_DetalleMatriculas(DetalleMatricula entity)
		{
			this.SendPropertyChanging();
			entity.Curso = this;
		}
		
		private void detach_DetalleMatriculas(DetalleMatricula entity)
		{
			this.SendPropertyChanging();
			entity.Curso = null;
		}
		
		private void attach_PeriodoGradoCursos(PeriodoGradoCurso entity)
		{
			this.SendPropertyChanging();
			entity.Curso = this;
		}
		
		private void detach_PeriodoGradoCursos(PeriodoGradoCurso entity)
		{
			this.SendPropertyChanging();
			entity.Curso = null;
		}
			...
			set
			{
							...
							|| (this._Curso.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.DetalleMatriculas.Remove(this);
					}
					this._Curso.Entity = value;
					if ((value != null))
					{
						value.DetalleMatriculas.Add(this);
	...
	public partial class Docente : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<DocentePeriodo> _DocentePeriodos;
    ...
    partial void OnBHABILITADOChanged();
		...
		public Docente()
		{
			this._DocentePeriodos = new EntitySet<DocentePeriodo>(new Action<DocentePeriodo>(this.attach_DocentePeriodos), new Action<DocentePeriodo>(this.detach_DocentePeriodos));
			this._GradoSeccionAulas = new EntitySet<GradoSeccionAula>(new Action<GradoSeccionAula>(this.attach_GradoSeccionAulas), new Action<GradoSeccionAula>(this.detach_GradoSeccionAulas));
			this._Sexo = default(EntityRef<Sexo>);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Docente_DocentePeriodo", Storage="_DocentePeriodos", ThisKey="IIDDOCENTE", OtherKey="IIDDOCENTE")]
		public EntitySet<DocentePeriodo> DocentePeriodos
		{
			get
			{
				return this._DocentePeriodos;
			}
			set
			{
				this._DocentePeriodos.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Docente_GradoSeccionAula", Storage="_GradoSeccionAulas", ThisKey="IIDDOCENTE", OtherKey="IIDDOCENTE")]
		public EntitySet<GradoSeccionAula> GradoSeccionAulas
		{
			get
			{
		...
		private void attach_DocentePeriodos(DocentePeriodo entity)
		{
			this.SendPropertyChanging();
			entity.Docente = this;
		}
		
		private void detach_DocentePeriodos(DocentePeriodo entity)
		{
			this.SendPropertyChanging();
			entity.Docente = null;
		}
			...
			set
			{
							...
							|| (this._Docente.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.DocentePeriodos.Remove(this);
					}
					this._Docente.Entity = value;
					if ((value != null))
					{
						value.DocentePeriodos.Add(this);
	...
	public partial class Grado : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<GradoSeccion> _GradoSeccions;
    ...
    partial void OnBHABILITADOChanged();
		...
		public Grado()
		{
			this._GradoSeccions = new EntitySet<GradoSeccion>(new Action<GradoSeccion>(this.attach_GradoSeccions), new Action<GradoSeccion>(this.detach_GradoSeccions));
			this._GradoSeccionAulas = new EntitySet<GradoSeccionAula>(new Action<GradoSeccionAula>(this.attach_GradoSeccionAulas), new Action<GradoSeccionAula>(this.detach_GradoSeccionAulas));
			this._Matriculas = new EntitySet<Matricula>(new Action<Matricula>(this.attach_Matriculas), new Action<Matricula>(this.detach_Matriculas));
			this._PeriodoGradoCursos = new EntitySet<PeriodoGradoCurso>(new Action<PeriodoGradoCurso>(this.attach_PeriodoGradoCursos), new Action<PeriodoGradoCurso>(this.detach_PeriodoGradoCursos));
			OnCreated();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Grado_GradoSeccion", Storage="_GradoSeccions", ThisKey="IIDGRADO", OtherKey="IIDGRADO")]
		public EntitySet<GradoSeccion> GradoSeccions
		{
			get
			{
				return this._GradoSeccions;
			}
			set
			{
				this._GradoSeccions.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Grado_GradoSeccionAula", Storage="_GradoSeccionAulas", ThisKey="IIDGRADO", OtherKey="IIDPERIODO")]
		public EntitySet<GradoSeccionAula> GradoSeccionAulas
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Grado_Matricula", Storage="_Matriculas", ThisKey="IIDGRADO", OtherKey="IIDGRADO")]
		public EntitySet<Matricula> Matriculas
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Grado_PeriodoGradoCurso", Storage="_PeriodoGradoCursos", ThisKey="IIDGRADO", OtherKey="IIDGRADO")]
		public EntitySet<PeriodoGradoCurso> PeriodoGradoCursos
		{
			get
			{
		...
		private void attach_GradoSeccions(GradoSeccion entity)
		{
			this.SendPropertyChanging();
			entity.Grado = this;
		}
		
		private void detach_GradoSeccions(GradoSeccion entity)
		{
			this.SendPropertyChanging();
			entity.Grado = null;
		}
			...
			set
			{
							...
							|| (this._Grado.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.GradoSeccions.Remove(this);
					}
					this._Grado.Entity = value;
					if ((value != null))
					{
						value.GradoSeccions.Add(this);
    ...
    partial void OnIIDCURSOChanged();
		...
		public System.Nullable<int> IIDPERIODO
		{
			...
			set
			{
				if ((this._IIDPERIODO != value))
				{
					if ((this._Grado.HasLoadedOrAssignedValue || this._Periodo.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnIIDPERIODOChanging(value);
			...
			set
			{
							...
							|| (this._Aula.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.GradoSeccionAulas.Remove(this);
					}
					this._Aula.Entity = value;
					if ((value != null))
					{
						value.GradoSeccionAulas.Add(this);
    ...
    partial void OnBHABILITADOChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Matricula_DetalleMatricula", Storage="_DetalleMatriculas", ThisKey="IIDMATRICULA", OtherKey="IIDMATRICULA")]
		public EntitySet<DetalleMatricula> DetalleMatriculas
		{
			get
			{
    ...
    partial void OnBHABILITADOChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ModalidadContrato_Docente", Storage="_Docentes", ThisKey="IIDMODALIDADCONTRATO", OtherKey="IIDMODALIDADCONTRATO")]
		public EntitySet<Docente> Docentes
		{
			get
			{
    ...
    partial void OnBHABILITADOChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Periodo_DocentePeriodo", Storage="_DocentePeriodos", ThisKey="IIDPERIODO", OtherKey="IIDPERIODO")]
		public EntitySet<DocentePeriodo> DocentePeriodos
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Periodo_GradoSeccionAula", Storage="_GradoSeccionAulas", ThisKey="IIDPERIODO", OtherKey="IIDPERIODO")]
		public EntitySet<GradoSeccionAula> GradoSeccionAulas
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Periodo_Matricula", Storage="_Matriculas", ThisKey="IIDPERIODO", OtherKey="IIDPERIODO")]
		public EntitySet<Matricula> Matriculas
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Periodo_PeriodoGradoCurso", Storage="_PeriodoGradoCursos", ThisKey="IIDPERIODO", OtherKey="IIDPERIODO")]
		public EntitySet<PeriodoGradoCurso> PeriodoGradoCursos
		{
			get
			{
		...
		public Curso Curso
		{
			...
			set
			{
							...
							|| (this._Curso.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Curso.Entity = null;
						previousValue.PeriodoGradoCursos.Remove(this);
					}
					this._Curso.Entity = value;
					if ((value != null))
					{
						value.PeriodoGradoCursos.Add(this);
						this._IIDCURSO = value.IIDCURSO;
					}
					else
					{
    ...
    partial void OnBHABILITADOChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Seccion_GradoSeccion", Storage="_GradoSeccions", ThisKey="IIDSECCION", OtherKey="IIDSECCION")]
		public EntitySet<GradoSeccion> GradoSeccions
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Seccion_GradoSeccionAula", Storage="_GradoSeccionAulas", ThisKey="IIDSECCION", OtherKey="IIDGRADOSECCION")]
		public EntitySet<GradoSeccionAula> GradoSeccionAulas
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Seccion_Matricula", Storage="_Matriculas", ThisKey="IIDSECCION", OtherKey="IIDSECCION")]
		public EntitySet<Matricula> Matriculas
		{
			get
			{
